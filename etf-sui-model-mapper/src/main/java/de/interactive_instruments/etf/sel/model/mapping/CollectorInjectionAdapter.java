...
public final class CollectorInjectionAdapter implements Environment, TestResultCollectorInjector {
	...
	TestResultCollector getTestResultCollector() {
		return collector;
	}

	@Override public void setTestResultCollector(final TestResultCollector testResultCollector) {
	...
	@Override public Service addNewService(final String s, final ServiceConfig.Type.Enum anEnum) {
		return null;
	}

	@Override public void removeService(final Service service) {

	}

	@Override public Property addNewProperty(final String s, final String s1) {
		return null;
	}

	@Override public void removeProperty(final Property property) {

	}

	@Override public void changePropertyName(final String s, final String s1) {

	}

	@Override public void moveProperty(final String s, final int i) {

	}

	@Override public void setName(final String s) {
