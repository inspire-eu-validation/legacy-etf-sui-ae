...
/**
 * This core will be injected as root core and acts as a proxy for a StandaloneSoapUICore (used in the GUI version). It
 * exchanges the SoapUIExtensionClassLoader.
 *
